use dioxus::prelude::*;
use crate::{Checkbox, CheckboxSize, Label};
...
pub fn checkbox_showcase(props: CheckboxShowcaseProps) -> Element {
    let CheckboxShowcaseProps { mut checkbox_1, mut checkbox_2, mut checkbox_3 } = props;
    rsx! {
        ComponentShowcase {
