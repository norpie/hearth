use dioxus::prelude::*;
use crate::{Card, CardVariant, CardSize, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Button, ButtonVariant, Input, InputType, Label, Progress};
                ...
                div { class: "space-y-6",
                    div { class: "grid grid-cols-1 md:grid-cols-3 gap-4",
                        Card {
                            ...
                            CardContent {
                                div { class: "text-center",
                                    div { class: "text-2xl font-bold text-blue-600", "24" }
                                    div { class: "text-sm text-gray-500", "Active Users" }
                                }
                            }
                        }
                        ...
                        Card {
                            ...
                            CardContent {
                                div { class: "text-center",
                                    div { class: "text-2xl font-bold text-green-600", "156" }
                                    div { class: "text-sm text-gray-500", "Messages Today" }
                                }
                            }
                        }
                        ...
                        Card {
                            ...
                            CardContent {
                                div { class: "text-center",
                                    div { class: "text-2xl font-bold text-purple-600", "92%" }
                                    div { class: "text-sm text-gray-500", "Uptime" }
                                }
                            }
                        }
                    }
