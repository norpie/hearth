use dioxus::prelude::*;
use crate::{Textarea, TextareaVariant, TextareaSize, TextareaResize, Label};
...
pub fn textarea_showcase(props: TextareaShowcaseProps) -> Element {
    let TextareaShowcaseProps { mut default_textarea, mut filled_textarea, mut outline_textarea, mut ghost_textarea } = props;
    rsx! {
        ComponentShowcase {
