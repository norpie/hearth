use dioxus::prelude::*;
use crate::{Slider, SliderSize, Label};
...
pub fn slider_showcase(props: SliderShowcaseProps) -> Element {
    let SliderShowcaseProps { mut slider_volume, mut slider_temperature, slider_range: _, slider_small: _, slider_medium: _, slider_large: _, slider_normal: _ } = props;
    rsx! {
        ComponentShowcase {
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-6",
                    div {
                        ...
                        Slider {
                            value: slider_volume.read().clone(),
                            min: 0.0,
                            max: 100.0,
                            step: 1.0,
                    ...
                    div {
                        ...
                        Slider {
                            value: slider_temperature.read().clone(),
                            min: 0.0,
                            max: 2.0,
                            step: 0.1,
