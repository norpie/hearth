use dioxus::prelude::*;
use crate::{Select, SelectOption, SelectVariant, SelectSize};
...
pub fn select_showcase(props: SelectShowcaseProps) -> Element {
    let SelectShowcaseProps { mut select_theme, mut select_size, mut select_framework } = props;
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-4",
                    ...
                    div { class: "grid grid-cols-1 md:grid-cols-2 gap-4",
                        div { class: "space-y-2",
                            label { class: "block text-sm font-medium text-gray-700 dark:text-gray-300", "Country (Searchable)" }
                            Select {
                                searchable: true,
                                options: vec![
                        ...
                        div { class: "space-y-2",
                            label { class: "block text-sm font-medium text-gray-700 dark:text-gray-300", "Programming Language" }
                            Select {
                                searchable: true,
                                variant: SelectVariant::Filled,
                                options: vec![
                    ...
                    div { class: "mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg",
                        h4 { class: "font-medium text-blue-900 dark:text-blue-100 mb-2", "Search Features" }
