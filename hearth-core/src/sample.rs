...
pub fn sample_characters() -> Vec<CharacterItem> {
    vec![
        CharacterItem {
            ...
            avatar_url: None,
            tags: vec!["Fantasy".to_string(), "Friendly".to_string(), "Tavern Keeper".to_string(), "Mysterious".to_string(), "Cheerful".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            description: "Loyal companion and medical expert with keen observation skills".to_string(),
            avatar_url: None,
            tags: vec!["Victorian".to_string(), "Detective".to_string(), "Medical".to_string(), "Loyal".to_string(), "Observant".to_string(), "Companion".to_string()],
            is_favorite: false,
        ...
        CharacterItem {
            ...
            description: "Experienced starship captain leading dangerous missions across the galaxy".to_string(),
            avatar_url: None,
            tags: vec!["Sci-Fi".to_string(), "Leader".to_string(), "Space".to_string(), "Captain".to_string(), "Experienced".to_string(), "Starship".to_string(), "Dangerous".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            avatar_url: None,
            tags: vec!["Fantasy".to_string(), "Magic".to_string(), "Student".to_string(), "Sorceress".to_string(), "Enigmatic".to_string(), "Forbidden".to_string(), "Academy".to_string(), "Dark Arts".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            description: "Hard-boiled detective solving crimes in the gritty city streets".to_string(),
            avatar_url: None,
            tags: vec!["Modern".to_string(), "Crime".to_string(), "Investigator".to_string(), "Hard-boiled".to_string(), "Gritty".to_string()],
            is_favorite: false,
        ...
        CharacterItem {
            ...
            description: "Cybernetic engineer navigating the neon-lit streets of Neo Tokyo".to_string(),
            avatar_url: None,
            tags: vec!["Cyberpunk".to_string(), "Tech".to_string(), "Hacker".to_string(), "Engineer".to_string(), "Neo Tokyo".to_string(), "Neon".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            description: "Noble princess fighting to save her kingdom from ancient evil".to_string(),
            avatar_url: None,
            tags: vec!["Fantasy".to_string(), "Royal".to_string(), "Brave".to_string(), "Princess".to_string(), "Noble".to_string(), "Kingdom".to_string(), "Ancient Evil".to_string()],
            is_favorite: false,
        ...
        CharacterItem {
            ...
            description: "Battle-hardened military commander leading the resistance against alien invaders".to_string(),
            avatar_url: None,
            tags: vec!["Sci-Fi".to_string(), "Military".to_string(), "Leader".to_string(), "Commander".to_string(), "Resistance".to_string(), "Alien Invaders".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            description: "Passionate artist seeking love and inspiration in the modern world".to_string(),
            avatar_url: None,
            tags: vec!["Romance".to_string(), "Artist".to_string(), "Creative".to_string(), "Passionate".to_string(), "Inspiration".to_string()],
            is_favorite: false,
        ...
        CharacterItem {
            ...
            avatar_url: None,
            tags: vec!["Historical".to_string(), "Scholar".to_string(), "Adventurer".to_string(), "Desert".to_string(), "Nomad".to_string(), "Ancient Mysteries".to_string()],
            is_favorite: true,
        ...
        CharacterItem {
            ...
            description: "Brilliant surgeon balancing life and death decisions in the ER".to_string(),
            avatar_url: None,
            tags: vec!["Medical".to_string(), "Drama".to_string(), "Professional".to_string(), "Surgeon".to_string(), "Brilliant".to_string(), "Life and Death".to_string(), "ER".to_string()],
            is_favorite: false,
        ...
        CharacterItem {
            ...
            avatar_url: None,
            tags: vec!["Supernatural".to_string(), "Dark".to_string(), "Ancient".to_string(), "Vampire".to_string(), "Mysterious".to_string(), "Centuries Old".to_string(), "Secrets".to_string(), "Lord".to_string()],
            is_favorite: true,
