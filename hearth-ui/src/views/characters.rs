...
use crate::{
    sample_character_tags_sorted, sample_characters, PageHeader, Platform, Route, SearchContext, 
...
use hearth_core::models::CharacterItem;
...
fn CharacterCard(
    ...
    let character_id_fav = character.id.clone();

    rsx! {
        div {
            class: "cursor-pointer hover:shadow-md transition-shadow",
            onclick: move |_| on_select.call(character_id.clone()),
            Card {
            ...
            CardContent {
                        ...
                        div { class: "flex items-center justify-between mb-1",
                            ...
                            Button {
                                ...
                                onclick: move |e: MouseEvent| {
                                    e.stop_propagation();
                                    on_favorite.call(character_id_fav.clone());
                                },
                ...
                div { class: "flex items-center space-x-4 text-sm text-muted-foreground",
                    if let Some(last_used) = &character.last_used {
                    ...
                    div { class: "flex items-center space-x-1",
                        ...
                        span { 
                            ...
                            if character.story_count == 1 { "story" } else { "stories" }
                        }
                    }
                }
            }
