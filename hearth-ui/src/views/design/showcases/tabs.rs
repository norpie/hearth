use dioxus::prelude::*;
use crate::{Tabs, TabsVariant, TabsSize, TabsList, TabsTrigger, TabsContent, Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Label, Input, InputType, Switch, Checkbox, Button};
    ...
    TabsContent { value: 0,
        div { "Settings content..." }
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-8",
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Default" }
                        Tabs {
                    ...
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Pills" }
                        Tabs {
                            variant: TabsVariant::Pills,
                            default_value: 1,
                            TabsList {
                    ...
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Underlined" }
                        Tabs {
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-8",
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Small" }
                        Tabs {
                            variant: TabsVariant::Pills,
                            size: TabsSize::Small,
                            default_value: 0,
                    ...
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Medium (Default)" }
                        Tabs {
                            variant: TabsVariant::Default,
                    ...
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Large" }
                        Tabs {
                            variant: TabsVariant::Pills,
                            size: TabsSize::Large,
                            default_value: 0,
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-8",
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "With Disabled Tab" }
                        Tabs {
                            variant: TabsVariant::Default,
                            default_value: 0,
                            TabsList {
                    ...
                    div {
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Rich Content" }
                        Tabs {
                            variant: TabsVariant::Pills,
                            default_value: 0,
                            TabsList {
