...
pub fn toggle_group_showcase() -> Element {
    ...
    // children...
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-4",
                    div { class: "flex items-center space-x-4",
                        span { class: "text-sm font-medium text-gray-700 dark:text-gray-300", "Format:" }
                        ToggleGroup {
                            exclusive: false,
                            value: text_format(),
                            size: ToggleSize::Small,
                        ...
                        span { class: "text-sm font-medium text-gray-700 dark:text-gray-300", "Align:" }
                        ToggleGroup {
                            exclusive: true,
                            value: text_align(),
                            size: ToggleSize::Small,
                    ...
                    div { class: "p-4 bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700",
                        p {
                            class: format!(
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-4",
                    div { class: "flex items-center space-x-3",
                        span { class: "text-sm font-medium text-gray-700 dark:text-gray-300", "Show files:" }
                        ToggleGroup {
                            exclusive: false,
                            value: file_types(),
                            size: ToggleSize::Small,
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-4",
                    div { class: "flex items-start space-x-6",
                        div {
                            h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300 mb-3", "Priority:" }
                            ToggleGroup {
                                exclusive: true,
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-6",
                    div { class: "space-y-3",
                        h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Sizes" }
                        div { class: "space-y-3",
                            div { class: "flex items-center space-x-4",
                                span { class: "text-sm text-gray-600 dark:text-gray-400 w-16", "Small:" }
                                ToggleGroup {
                                    exclusive: true,
                                    size: ToggleSize::Small,
                            ...
                            div { class: "flex items-center space-x-4",
                                span { class: "text-sm text-gray-600 dark:text-gray-400 w-16", "Medium:" }
                                ToggleGroup {
                                    exclusive: true,
                            ...
                            div { class: "flex items-center space-x-4",
                                span { class: "text-sm text-gray-600 dark:text-gray-400 w-16", "Large:" }
                                ToggleGroup {
                                    exclusive: true,
                    ...
                    div { class: "space-y-3",
                        h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Variants" }
                        div { class: "space-y-3",
                            div { class: "flex items-center space-x-4",
                                span { class: "text-sm text-gray-600 dark:text-gray-400 w-16", "Default:" }
                                ToggleGroup {
                                    exclusive: false,
                            ...
                            div { class: "flex items-center space-x-4",
                                span { class: "text-sm text-gray-600 dark:text-gray-400 w-16", "Outline:" }
                                ToggleGroup {
                                    exclusive: false,
                                    variant: ToggleVariant::Outline,
