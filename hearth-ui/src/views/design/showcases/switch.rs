use dioxus::prelude::*;
use crate::{Switch, SwitchSize, Label};
...
pub fn switch_showcase(props: SwitchShowcaseProps) -> Element {
    let SwitchShowcaseProps { mut switch_1, mut switch_2, mut switch_3 } = props;
    rsx! {
        ComponentShowcase {
