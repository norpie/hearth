...
use crate::{Calendar, CalendarSize, SimpleDate, ToastConfig, ToastType, ToastManager};
    ...
    on_date_select: move |date| {
        // Handle date selection
            ...
            ShowcaseVariant {
                ...
                div { class: "flex justify-center",
                    Calendar {
                        class: Some("border-2 border-blue-200 dark:border-blue-800 shadow-lg".to_string()),
            ...
            ShowcaseVariant {
                ...
                div { class: "grid grid-cols-1 md:grid-cols-2 gap-6",
                    div { class: "flex flex-col items-center space-y-2",
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300", "August 2024" }
                        Calendar {
                    ...
                    div { class: "flex flex-col items-center space-y-2",
                        h4 { class: "text-sm font-medium text-gray-700 dark:text-gray-300", "September 2024" }
                        Calendar {
