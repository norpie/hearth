...
pub fn toggle_showcase() -> Element {
    ...
    "Toggle"
            ...
            ShowcaseVariant {
                ...
                div { class: "space-y-6",
                    div { class: "space-y-3",
                        h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Default" }
                        div { class: "flex items-center space-x-2",
                            Toggle {
                    ...
                    div { class: "space-y-3",
                        h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Outline" }
                        div { class: "flex items-center space-x-2",
                            Toggle {
                                variant: ToggleVariant::Outline,
                ...
                div { class: "space-y-4",
                    ...
                    div { class: "space-y-3",
                        div { class: "flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-md",
                            div {
                                h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Dark Mode" }
                                p { class: "text-sm text-gray-600 dark:text-gray-400", "Switch to dark theme" }
                            }
                            Toggle {
                                pressed: false,
                                size: ToggleSize::Small,
                        ...
                        div { class: "flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-md",
                            div {
                                h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Notifications" }
                                p { class: "text-sm text-gray-600 dark:text-gray-400", "Receive push notifications" }
                            }
                            Toggle {
                                pressed: true,
                                size: ToggleSize::Small,
                        ...
                        div { class: "flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-md",
                            div {
                                h4 { class: "font-medium text-gray-900 dark:text-gray-100", "Auto-save" }
                                p { class: "text-sm text-gray-600 dark:text-gray-400", "Automatically save changes" }
                            }
                            Toggle {
                                pressed: true,
                                size: ToggleSize::Small,
